...
* Works only with polymorphic classes because,it uses this information to decide safe downcasting.
* A Dynamic_cast has runtime overhead because it checks object types at run time using RTTI.

* RTTI (Run-time type information) is a mechanism that exposes information about an object’s data type 
